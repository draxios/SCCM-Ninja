Module modMain
    ...
    Public KeepLog As Boolean = True

    Public Sub WriteToLog(text As String)
        On Error Resume Next
        If KeepLog = True Then System.IO.File.AppendAllText("\\stl-fs-i03\Public_Users\Users\E425N5\Logs\Ninja\" & Environment.UserName & "-" & Now.ToString("MMddyyyy") & ".log", Environment.UserName & " (" & Now() & "): " & text & vbNewLine)
    End Sub
